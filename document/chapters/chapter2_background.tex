...
Datacenter servers are the main component of the datacenter. They are responsible for the processing of the data and the execution of the applications.

As the main component of the dacatencer, they are also the main contributor for the energy consumption of the datacenter. According to \citet{Cheung} and \citet{Miyuru} the servers account for around 70\% of the energy consumption of the datacenter, ignoring cooling and other non \ac{it} factors.
